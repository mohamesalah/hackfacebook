...
\t |$   $|      |$  $\ 
\t |$   $|      |$   $\ 
my page : https://www.facebook.com/a7medabdelnabi/
my channel : https://www.youtube.com/channel/UCKaFk40Y16to0QDOOLxIZ7g
".$blue."Facebook BF_HK
".$cyan."Geart: HK\n\n".$nc;
$file = $_SERVER[argv][1];
echo "$white writing ID Target:$yellow ";
$user = trim(fgets(STDIN));
echo "$white enter file password.txt:$yellow ";
